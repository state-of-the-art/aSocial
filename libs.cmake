...
file(GLOB sublibs RELATIVE "${_libs_dir}" "${_libs_dir}/*")
unset(LIBS_LIST)
foreach(sublib ${sublibs})
    if(DEFINED lib_${sublib}_loaded)
        #message("Skipping already loaded lib: ${lib}")
        continue()
    endif()
    set(lib_${sublib}_loaded ON)
    if(IS_DIRECTORY ${_libs_dir}/${sublib})
        list(APPEND LIBS_LIST "${sublib}")
    endif()
endforeach()
...
foreach(lib ${LIBS_LIST})
    ...
    include(${_libs_dir}/${lib}/config.cmake OPTIONAL)
